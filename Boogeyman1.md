...
Analysis & Methodology: Opened the raw source code of dump.eml to review the cryptographic authentication headers. Located the DKIM-Signature header field and identified the signing Response: elasticemail
